function [matrix,positions,connection,connectible,fc_abs,w,fc]=devolution3d_ng_ray_parallel(n,limit,flagtaken,flagsize,cellradius,flagdistance,mplaces,range)
% function [matrix,positions,connection,clength,connectible,fc_abs,w,fc]=devolution3d_ng_ray_parallel(n,flagtaken,flagsize,flagdistance,mplaces,range)
...
for i=1:n
        ...
        if flagdistance==0
            ...
            tempcellsize=cellsize; %*ones(n,1); already n by 1
   ...
   cind_mat=cell2mat(cind);
   cind_sort=sortrows(cind_mat,4);
   connection=cell(1000,1);
   clength=cell(1000,1);
